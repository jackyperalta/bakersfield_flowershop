...
-- Possible constraint for zip codes?
...
CREATE TABLE IF NOT EXISTS product_order (
    p_order_number SERIAL PRIMARY KEY not null, --PK
...
CREATE TABLE IF NOT EXISTS incoming_payment (
	...
	--CONSTRAINT pk_incoming_payment PRIMARY KEY(payment_id),
	--CONSTRAINT fk_incoming_payment FOREIGN KEY (payment_id)
...
CREATE TABLE IF NOT EXISTS outgoing_payment (
	...
	--CONSTRAINT pk_outgoing_payment PRIMARY KEY (payment_id),
...
CREATE TABLE IF NOT EXISTS requires (
	...
	--CHECK (is_in_other_table(payment_id))
);
...
-- 	CONSTRAINT fk_requires_order_number FOREIGN KEY (p_order_number)
-- 		REFERENCES product_order(p_order_number),
-- 	CONSTRAINT fk_requires_payment FOREIGN KEY (payment_id)
-- 		REFERENCES payment(payment_id)
...
-- 		PRIMARY KEY (supply_purchase_id, payment_id),

-- 	CONSTRAINT fk_needs_supply_purchase FOREIGN KEY (supply_purchase_id)
-- 		REFERENCES supply_purchase_order(supply_purchase_id),
-- 	CONSTRAINT fk_needs_payment FOREIGN KEY (payment_id)
-- 		REFERENCES payment(payment_id)
--  );

 CREATE TABLE IF NOT EXISTS needs (
	supply_purchase_id INT not null,
 	outgoing_payment_id INT not null,
 ...
 CREATE TABLE IF NOT EXISTS refills (
    ...
    product_id integer not null,
    quantity_item integer not null UNIQUE,
...
-- todo add into report
-- MAy need more constraints for making sure
-- employee isn't working shift twice
-- look into psql notify
